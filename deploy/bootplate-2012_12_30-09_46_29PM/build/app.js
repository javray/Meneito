...
enyo.path.addPaths({layout: "/Users/javray/Documents/Proyectos/Meneame/bootplate/enyo/tools/../../lib/layout/", onyx: "/Users/javray/Documents/Proyectos/Meneame/bootplate/enyo/tools/../../lib/onyx/", onyx: "/Users/javray/Documents/Proyectos/Meneame/bootplate/enyo/tools/../../lib/onyx/source/"});
...
return i = i.split("&#039;").join("'"), i = i.split("&#39;").join("'"), i = i.split("&#34;").join('"'), i = i.split("&#38;").join("&"), i;
}
...
name: "domain",
style: "float:right;font-size:11px;color:lightsalmon"
}, {
name: "user",
classes: "icon-user",
...
n.style.height = r - this.tam + "px", (t.index == this.items.length - 1 || t.index == this.items.length - 2) && this.scrollToBottom();
},
seleccionado: function(e, t) {
var n = document.getElementById(this.id + "_port"), r = +n.style.height.split("px")[0];
this.tam = document.querySelector('[data-enyo-index="' + t.index + '"]').offsetHeight - 100, n.style.height = r + this.tam + "px", (t.index == this.items.length - 1 || t.index == this.items.length - 2) && this.scrollToBottom();
},
itemsChanged: function() {
var e = [];
this.mostrados = [], this.items.forEach(function(t, n) {
var r = t.description.split("<p>"), i = t.url.split("/");
e[e.length] = {
title: t.title,
description: html_entity_decode(strip_tags(r[1])),
votes: t.votes,
comments: isNaN(t.comments[1]) ? t.comments[0] : t.comments[1],
domain: i[2],
url: t.url,
murl: t.comments[0],
thumb: t.thumbnail ? t.thumbnail.url : null,
user: t.user,
id: t.link_id
};
}), this.items = e, this.setCount(this.items.length), this.pulled ? this.completePull() : this.reset();
},
setupItem: function(e, t) {
var n = t.index, r = this.items[n];
this.items.length > 0 && (this.$.title.setContent(r.title), this.$.descripcion.setDescription(r.description), this.$.votes.setContent(r.votes), this.$.comments.setContent(" " + r.comments), this.$.user.setContent(" " + r.user), this.$.domain.setContent(r.domain), t.originator.isSelected(n) && !this.$.descripcion.showing ? (r.thumb != null ? this.$.descripcion.setThumb(r.thumb) : this.$.descripcion.setThumb(""), this.$.descripcion.show(), this.$.controles.show(), this.scrollToRow(n), this.$.controles.setSubject(r.title), this.$.controles.setText(r.url), this.$.controles.setCid(r.id), this.$.controles.setUrl(r.url), this.$.controles.setMurl(r.murl)) : (this.$.descripcion.hide(), this.$.controles.hide()));
},
soltar: function() {
...
completar: function() {
this.pulled = !1, this.reset();
},
pulse: function(e, t) {
this.renderRow(t.index);
}
}), enyo.kind({
name: "Peticiones",
components: [ {
...
noticias: function(e, t) {
var n = MENEAME[t.feed], r = new enyo.JsonpRequest({
url: n,
callbackName: "callback"
});
r.response(this, function(e, n) {
...
components: [ {
name: "portada",
style: "width: 50%;border-right:1px solid grey;height:57px;position:relative; bottom: 9px;text-align:center",
classes: "icono on",
components: [ {
style: "5px; font-size: 30px",
classes: "icon-newspaper"
}, {
...
name: "pendientes",
style: "width: 50%;height: 57px;position:relative;bottom: 9px;text-align: center",
classes: "icono",
components: [ {
style: "font-size: 30px",
classes: "icono icon-list"
}, {
style: "font-size: 10px",
content: "Pendientes"
} ]
...
e.removeClass("on");
}), e.addClass("on"), enyo.Signals.send("onPanel", e.name);
}
}), enyo.kind({
name: "Comentarios",
kind: "List",
...
name: "principal",
style: "padding: 10px;",
classes: "enyo-border-box list-item-comments",
components: [ {
style: "float:left;height:40px;width:20%;font-weight:bold",
components: [ {
name: "orden",
style: "font-size:35px;margin-right:5px;color: orange"
} ]
}, {
name: "contenido",
showing: !0,
...
components: [ {
name: "karma",
classes: "icon-thermometer",
style: "float: right;color: salmon;font-size:11px;margin: 2px 2px 0px 0px"
}, {
name: "votes",
classes: "icon-flag",
style: "float: right;color: salmon;font-size:11px;margin: 2px 2px 0px 0px"
...
itemsChanged: function() {
var e = [];
this.indice = 10, this.items.forEach(function(t, n) {
var r = t.description.split("<p>");
e.unshift({
orden: t.order,
descripcion: html_entity_decode(strip_tags(r[1])),
user: t.user,
votes: t.votes,
karma: t.karma
});
}), this.items = e, this.indice = this.indice > e.length ? e.length : this.indice, this.setCount(this.indice), this.reset();
},
setupItem: function(e, t) {
var n = t.index, r = this.items[n];
this.items.length > 0 && (this.$.orden.setContent(r.orden), this.$.descripcion.setContent(r.descripcion), this.$.user.setContent(" " + r.user), this.$.votes.setContent(" " + r.votes), this.$.karma.setContent(" " + r.karma));
},
scrollstop: function(e, t) {
var n = this.getScrollBounds(), r = this.indice, i = this.items.length;
...
error: function(e, t) {
this.$.cargando.hide(), this.$.error.setPagina(t.name), this.$.error.show();
},
reintentar: function() {
this.$.error.hide(), this.$.cargando.show(), enyo.Signals.send("onNoticias", {
...
panel: function(e, t) {
this.$.paneles.getIndex() != MENEAME.secciones[t] && (this.$.paneles.setIndex(MENEAME.secciones[t]), this.$.cargando.show(), enyo.Signals.send("onNoticias", {
feed: t,
obj: this.$[t]
}));
},
